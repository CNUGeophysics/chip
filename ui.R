...
ui <- fluidPage(
  ...
  navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
                                  ...
                                  tabPanel("title" = "Step 1",
                                           sidebarLayout(
                                             sidebarPanel(
                                               ...
                                               h4(HTML("<b>Check Duplicated</b>"), style = "color:red"),
                                               useShinyjs(),
                                               br(),
                                   ...
                                   tabPanel(title = "Step 3",
                                            sidebarLayout(
                                              ...
                                              mainPanel(
                                                ...
                                                br(),
                                               withSpinner(uiOutput("valueUpload"))
                                              )
                                            )
                                   ),
                                   ...
                                   tabPanel(title = "Step 4",        
                                            ...
                                            sidebarLayout(
                                              ...
                                              sidebarPanel(
                                                ...
                                                h4(HTML("<b>Submin Data</b>"), style = "color:red"),
             ...
             navbarMenu("Board",
                        tabPanel("FAQ"),
                        tabPanel("Contact",
                                 tags$h3("Name: Su-Min,Yang"),
                                 tags$h3("Contact: +82-42-821-7567"),
                                 tags$h3("E-Mail: sumineee@o.cnu.ac.kr")
